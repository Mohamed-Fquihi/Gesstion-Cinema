...
public class CinemaInitServiceImpl implements ICinemaInitService {
	...
	public void initCinemas() {
		...
		villeRepository.findAll().forEach(v->{
			Stream.of("MegaRama","IMAX","RIF","DAOULIZ").forEach(nameCinema->{
	...
	public void initSeances() {
		...
		Stream.of("11:00","14:00","17:00","20:00","23:00").forEach(s->{
	...
	public void initfilms() {
		...
		Stream.of("BreakingBad","StrangerThings","TheFlash","ThePunisher","betterCallSaul","TheWalkingDead","titanic")
		.forEach(titreFilm->{
		Film film=new Film();
