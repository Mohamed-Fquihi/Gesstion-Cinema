...
public class CinemaRestController {
	...
	@Transactional
	public java.util.List<Ticket> payerTickets(@RequestBody TicketFrom ticketFrom) {
		 java.util.List<Ticket> listTickets=new ArrayList<>();
...
class TicketFrom{
 ...
 private java.util.List<Long> tickets=new ArrayList<>();
}
